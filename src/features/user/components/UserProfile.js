    ...
    <div>
      <div className="mx-auto  max-w-7xl px-4 sm:px-6 lg:px-8 bg-white">
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          ...
          {user.role==='admin' && <h3 className="text-xl my-5 font-bold tracking-tight text-red-500">
           role: {user.role}
          </h3>}
        </div>

        <div className="border-t border-gray-200 px-4 py-6 sm:px-6"><button
                        type="submit"
